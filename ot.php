...
<body class="sb-nav-fixed">
      ...
      <main>
        <div class="container-fluid px-4">
          ...
          <ol class="breadcrumb mb-4">
            ...
            <li class="breadcrumb-item active">Administrar ordenes de trabajo</li>
          </ol>
          <hr>
          <div class="row">
            <div class="col">
              <form action="clases/ot/ot.php" method="POST">
                <div class="form-group">
                  ...
                  <select class="form-control" id="cliente" name="cliente">
                    ...
                    $sql = "SELECT * 
                              FROM cliente 
                        INNER JOIN equipo ON equipo.cliente_idcliente = cliente.idcliente
                             WHERE cliente.estado = 'Activo'";
                    $resultado = mysqli_query($conexion, $sql);
                    while ($ver = mysqli_fetch_row($resultado)) {
                    ?>
                      <option value="<?php echo $ver[0] ?>,<?php echo $ver[10] ?>,<?php echo $ver[3] ?>,<?php echo $ver[1] ?>,<?php echo $ver[2] ?>,<?php echo $ver[6] ?>,<?php echo $ver[5] ?>,">
                        <?php echo "RUT: " . $ver[1] . " | Nombre y apellido: " . $ver[2] . " " . $ver[3] . " | Correo: " . $ver[6] . " | Direccion: " . $ver[4] . " | Telefono: " . $ver[5] . " | Tipo: " . $ver[11] . " | Marca: " . $ver[12] . " | Modelo: " . $ver[13] ?>
                      </option>
                    <?php
                    }
                    ?>
                ...
                <div class="form-row">
                  ...
                  <div class="form-group col-md-6">
                    <label for="isProductDiscounted">¿Se aplica algun descuento?</label>
                ...
                <div class="form-row">
                  ...
                  <div class="form-group col-md-6">
                    ...
                    <input type="number" class="form-control" id="discountPercentage" th:field="*{discountPercentage}" disabled name="descuento">
                    <small class="form-text text-danger" th:if="${#fields.hasErrors('discountPercentage')}" th:errors="*{discountPercentage}"></small>
                  </div>
                </div>
                <div class="form-row">
                  <div class="form-group col-md-6">
                    <label for="exampleFormControlTextarea1">Estado inicial:</label>
                    <textarea class="form-control"  rows="10" placeholder="Estado inicial del equipo" name="estadoInicial" id="estadoInicial" maxlength="300"></textarea>
                  </div>
                  <div class="form-group col-md-6">
                    <label for="exampleFormControlTextarea1">Diagnostico y observaciones:</label>
                    <textarea class="form-control"  rows="10" placeholder="Diagnostico y observaciones del equipo" name="diagnostico" id="diagnostico" maxlength="300"></textarea>
                  </div>
                </div>
                <div class="form-row">
                  <div class="form-group col-md-6">
                    <label for="inputEmail4">Fecha estimada de termino:</label>
                ...
                <button type="submit" class="btn btn-success" disabled id="registrar">Generar OT</button>
              </form>
              <hr>
  ...
  <script src="js/moduloOT.js"></script>
