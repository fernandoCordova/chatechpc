...
<body class="sb-nav-fixed">
        ...
        <div class="sb-sidenav-menu">
          ...
          <div class="nav">
            ...
            <div class="collapse" id="clientes" aria-labelledby="headingOne" data-bs-parent="#sidenavAccordion">
              ...
              <nav class="sb-sidenav-menu-nested nav">
                <a class="nav-link active" href="administrar_equipos.php">Administrar equipos</a>
              </nav>
            </div>
    ...
    <div id="layoutSidenav_content">
      <main>
        <div class="container-fluid px-4">
          <h1 class="mt-4">Módulo de equipos</h1>
          ...
          <div class="card mb-4" id="tablausuarios">
            <div class="card-header">
              <i class="fas fa-table me-1"></i> Listado de equipos con sus respectivos dueños
            </div>
            <div class="card-body">
              <table id="datatablesSimple">
                ...
                <tbody>
                  <?php
                  $sql = "SELECT cliente.rut, cliente.nombres, cliente.apellidos, cliente.telefono, cliente.cedula, 
                                 equipo.tipo, equipo.marca, equipo.modelo, equipo.sistema_operativo, equipo.idequipo
                            FROM equipo
                      INNER JOIN cliente
                              ON cliente.idcliente = equipo.cliente_idcliente";
                  ...
                  ?>
                    <tr>
                      ...
                      <td><a target="_blank" href="<?php echo $ver[4] ?>">Imagen</a></td>
                      <td><?php echo $ver[5] ?></td>
                      <td><?php echo $ver[6] ?></td>
                      <td><?php echo $ver[7] ?></td>
                      <td><?php echo $ver[8] ?></td>
                      <th>
                        <button onclick="GetUserDetails('<?php echo $ver[9] ?>')" class="btn btn-warning">Modificar</button>
                        <button onclick="DeleteUser('<?php echo $ver[9] ?>')" class="btn btn-danger">Eliminar</button>
                      </th>
                    </tr>
                  <?php
                  }
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          <div class="form-group">
            ...
            <input type="text" id="tipo" value="" class="form-control" placeholder="Ingrese el tipo de equipo" require />
            <div id="errorTipo"></div>
          </div>
          <div class="form-group">
            <label for="marca">Marca:</label>
            <input type="text" id="marca" value="" class="form-control" placeholder="Ingrese la marca" require />
            <div id="errorMarca"></div>
          </div>
          <div class="form-group">
            <label for="modelo">Modelo:</label>
            <input type="text" id="modelo" value="" class="form-control" placeholder="Ingrese el modelo" require />
            <div id="errorModelo"></div>
          </div>
          <div class="form-group">
            <label for="os">Sistema operativo:</label>
            <input type="text" id="os" value="" class="form-control" placeholder="Ingrese el sistema operativo" require />
            <div id="errorOS"></div>
          </div>
          <div class="form-group">
            <label for="cliente">Seleccione el cliente al que pertenece el equipo:</label>
            <select class="form-control" id="cliente" style="width: 465px;" require>
              <option value="">Seleccione un cliente</option>
              <?php
              $sql = "SELECT `idcliente`,`rut`,`nombres`,`apellidos` FROM `cliente`";
              $resultado = mysqli_query($conexion, $sql);
              while ($ver = mysqli_fetch_row($resultado)) {
              ?>
  ...
  <div class="modal fade" id="update_user_modal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        ...
        <div class="modal-body">
          <div class="form-group">
            <label for="update_tipo">Tipo de equipo:</label>
            <input type="text" id="update_tipo" value="" class="form-control" placeholder="Ingrese el tipo de equipo" require />
            <div id="update_errorTipo"></div>
          </div>
          <div class="form-group">
            <label for="update_marca">Marca:</label>
            <input type="text" id="update_marca" value="" class="form-control" placeholder="Ingrese la marca" require />
            <div id="update_errorMarca"></div>
          </div>
          <div class="form-group">
            <label for="update_modelo">Modelo:</label>
            <input type="text" id="update_modelo" value="" class="form-control" placeholder="Ingrese el modelo" require />
            <div id="update_errorModelo"></div>
          </div>
          <div class="form-group">
            <label for="update_os">Sistema operativo:</label>
            <input type="text" id="update_os" value="" class="form-control" placeholder="Ingrese el sistema operativo" require />
            <div id="update_errorOS"></div>
          </div>
          <div class="form-group">
            <label for="update_cliente">Seleccione el cliente al que pertenece el equipo:</label>
            <select class="form-control" id="update_cliente" style="width: 465px;" require>
              <option value="">Seleccione un cliente</option>
              <?php

              $sql = "SELECT cliente.idcliente, cliente.rut, cliente.nombres, cliente.apellidos FROM cliente";
              $resultado = mysqli_query($conexion, $sql);
              while ($ver = mysqli_fetch_row($resultado)) {
              ?>
                <option value="<?php echo $ver[0] ?>"><?php echo $ver[1] . " - " . $ver[2] . " " . $ver[3] ?></option>
            ...
            <div id="update_errorCliente"></div>
          </div>
        </div>
        <div class="modal-footer">
          <button type="button" class="btn btn-danger" data-dismiss="modal" onclick="window.location.reload();">Cancelar</button>
  ...
  <script src="js/moduloEquipos.js"></script>
