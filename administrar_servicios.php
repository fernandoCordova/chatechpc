...
<body class="sb-nav-fixed">
      ...
      <nav class="sb-sidenav accordion sb-sidenav-dark" id="sidenavAccordion">
        <div class="sb-sidenav-menu">
          ...
          <div class="nav">
            ...
            <a class="nav-link active collapsed" href="#" data-bs-toggle="collapse" data-bs-target="#servicios" aria-expanded="false" aria-controls="collapseLayouts">
              <div class="sb-nav-link-icon"><i class="fas fa-columns"></i></div>
              Servicios
              <div class="sb-sidenav-collapse-arrow"><i class="fas fa-angle-down"></i></div>
            </a>
            <div class="collapse" id="servicios" aria-labelledby="headingOne" data-bs-parent="#sidenavAccordion">
              <nav class="sb-sidenav-menu-nested nav">
                <a class="nav-link active" href="administrar_servicios.php">Administrar servicios</a>
              </nav>
            </div>
    ...
    <div id="layoutSidenav_content">
      <main>
        <div class="container-fluid px-4">
          <h1 class="mt-4">Módulo de servicios</h1>
          ...
          <div class="card mb-4" id="tablausuarios">
            <div class="card-header">
              <i class="fas fa-table me-1"></i> Listado de servicios
            </div>
            <div class="card-body">
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          <div class="form-group">
            ...
            <input type="text" id="tipo" value="" class="form-control" placeholder="Ingrese el tipo de servicio" />
            <div id="errorTipo"></div>
          </div>
          <div class="form-group">
            <label for="monto">Monto:</label>
            <input type="number" id="monto" value="" class="form-control" placeholder="Ingrese el monto" />
  ...
  <div class="modal fade" id="update_user_modal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        ...
        <div class="modal-body">
          <div class="form-group">
            <label for="update_tipo">Tipo de servicio:</label>
            <input type="text" id="update_tipo" value="" class="form-control" placeholder="Ingrese el tipo de servicio" />
            <div id="update_errorTipo"></div>
          </div>
          <div class="form-group">
            <label for="update_monto">Monto:</label>
            <input type="number" id="update_monto" value="" class="form-control" placeholder="Ingrese el monto" />
            <div id="update_errorMonto"></div>
          </div>
          <div class="form-group">
  ...
  <script src="js/moduloServicios.js"></script>
