        ...
        <div class="sb-sidenav-menu">
          ...
          <div class="nav">
            ...
            <div class="collapse" id="productos" aria-labelledby="headingOne" data-bs-parent="#sidenavAccordion">
              <nav class="sb-sidenav-menu-nested nav">
                <a class="nav-link active" href="administrar_productos.php">Administrar productos</a>
              </nav>
              <nav class="sb-sidenav-menu-nested nav">
    ...
    <div id="layoutSidenav_content">
      <main>
        <div class="container-fluid px-4">
          <h1 class="mt-4">Módulo de productos</h1>
          ...
          <div class="card mb-4" id="tablausuarios">
            ...
            <div class="card-body">
              <table id="datatablesSimple">
                ...
                <tbody>
                  <?php
                  $sql = "SELECT producto.idproducto,producto.nombre,producto.cantidad,producto.precio,producto.estado,categoria.nombre 
                            FROM producto 
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          <div class="form-group">
            ...
            <input type="text" id="nombre" value="" class="form-control" placeholder="Ingrese el nombre de producto"  require/>
            <div id="errorNombre"></div>
          </div>
          <div class="form-group">
            <label for="cantidad">Cantidad del producto:</label>
            <input type="number" id="cantidad" value="" class="form-control" placeholder="Ingrese la cantidad de stock disponible" require/>
            <div id="errorCantidad"></div>
          </div>
          <div class="form-group">
            <label for="precio">Precio del producto:</label>
            <input type="number" id="precio" value="" class="form-control" placeholder="Ingrese el precio del producto" require/>
          ...
          <div class="form-group">
            ...
            <select class="form-control" id="categoria" style="width: 465px;" require>
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          <div class="form-group">
            ...
            <input type="text" id="update_nombre" value="" class="form-control" placeholder="Ingrese el nombre de producto" require/>
            <div id="update_errorNombre"></div>
          </div>
          <div class="form-group">
            <label for="update_cantidad">Cantidad del producto:</label>
            <input type="number" id="update_cantidad" value="" class="form-control" placeholder="Ingrese la cantidad de stock disponible" require/>
            <div id="update_errorCantidad"></div>
          </div>
          <div class="form-group">
            <label for="update_precio">Precio del producto:</label>
            <input type="number" id="update_precio" value="" class="form-control" placeholder="Ingrese el precio del producto" required/>
            <div id="update_errorPrecio"></div>
          </div>
          <div class="form-group">
          ...
          <div class="form-group">
            <label for="update_categoria">Categoría del producto:</label>
            <select class="form-control" id="update_categoria" style="width: 465px;" require>
              <option value="">Seleccione una categoria</option>
              <?php
              $sql = "SELECT * FROM categoria";
              $resultado = mysqli_query($conexion, $sql);
            ...
            <div id="update_errorCategoria"></div>
          </div>
        </div>
        <div class="modal-footer">
          <button type="button" class="btn btn-danger" data-dismiss="modal" onclick="window.location.reload();">Cancelar</button>
